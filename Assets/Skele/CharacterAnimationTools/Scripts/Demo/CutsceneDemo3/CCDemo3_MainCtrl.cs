...
public class CCDemo3_MainCtrl : MonoBehaviour
{
    ...
    public void OnHit(GameObject hit, GameObject beHit)
    {
        ...
        else //player hit the enemy
        {
            ...
            int atkStateHash = m_PlayerAnimator.GetCurrentAnimatorStateInfo(0).nameHash;
    ...
    public bool IsUnderAtk(GameObject go)
    {
        ...
        {
            st = animator.GetNextAnimatorStateInfo(0).nameHash;
        }
        else
        {
            st = animator.GetCurrentAnimatorStateInfo(0).nameHash;
        }
