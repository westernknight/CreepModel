...
{
    void SetBones(Transform endJoint, int len);
    bool Execute(float weight = 1.0f); 
    Vector3 Target { get; set; }
    int Count { get; } //get the bones in the link, not joints
    Transform[] GetJoints(); //get all joints, including the end-effector
}
